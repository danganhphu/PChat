...
public class GenericRepository<T> : IGenericRepository<T> where T : class
{
    ...
    public T FindInclude(Expression<Func<T, bool>> criteria, Expression<Func<T, object>> orderBy = null, string orderByDirection = OrderBy.Ascending,
    ...
    public T FindNoTraking(Expression<Func<T, bool>> criteria, string[] includes = null) =>
        _context.Set<T>().AsNoTracking().SingleOrDefault(criteria);

    public T FindNoTraking(Expression<Func<T, bool>> criteria, Expression<Func<T, bool>> criteria2, string[] includes = null) =>
        _context.Set<T>().Where(criteria).Where(criteria2).AsNoTracking().FirstOrDefault();

    public T FindNoTraking(Expression<Func<T, bool>> criteria, Expression<Func<T, bool>> criteria2, Expression<Func<T, bool>> criteria3,
        string[] includes = null) => _context.Set<T>().Where(criteria).Where(criteria2).Where(criteria3).AsNoTracking().FirstOrDefault();

    public T FindNoTraking(Expression<Func<T, bool>> criteria, Expression<Func<T, object>> orderBy = null) =>
        _context.Set<T>().Where(criteria).OrderBy(orderBy).AsNoTracking().FirstOrDefault();
    ...
    public T FindNoTraking(Expression<Func<T, bool>> criteria, Expression<Func<T, bool>> criteria2,
        ...
        _context.Set<T>().Where(criteria).Where(criteria2).OrderBy(orderBy).AsNoTracking().FirstOrDefault();
